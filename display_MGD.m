...
% Function to display the MGD

% Input the DH
%dh = [0, -90, 0, 0; 1, 0, 0, 0; 0, -90, 0, 0; 0, 0, 1, 0; 0, 90, 0, 0; 0, -90, 0, 0; 0, 0, 1, 0]

n = input('How many Links do you have: ');
...
x = MGD(1,4);
disp(sprintf('%.1f', x)) % Display x
y = MGD(2,4);
disp(sprintf('%.1f', y)) % Display y
z = MGD(3,4);
disp(sprintf('%.1f', z)) % Display z
